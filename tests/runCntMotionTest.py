...
def test(test_name):
    test_args = [test_executable,
                 "--gtest_filter=CntLinearMotionTest."+test_name]
...
if __name__ == "__main__":
    tests = ["Connect", "IsConnected", "MoveHome", "getSpeed", "setSpeed", "getPosition", "MoveCenter", "MoveDownTo",
             "MoveUpTo", "Pause", "Resume", "Disconnect"]
