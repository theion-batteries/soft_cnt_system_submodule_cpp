...
connect_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.Connect"]
...
isconnected_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.IsConnected"]
...
movehome_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.MoveHome"]
...
getspeed_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.getSpeed"]
...
setspeed_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.setSpeed"]
...
getposition_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.getPosition"]
...
movecenter_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.MoveCenter"]
...
movedownto_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.MoveDownTo"]
...
moveupto_test_args = [test_executable, "--gtest_filter=CntLinearMotionTest.MoveUpTo"]
